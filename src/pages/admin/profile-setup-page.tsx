import ProfileSetupForm from "@/components/custom/admin/profile-setup/profile-setup-form";
import {
  Card,
  CardContent,
  CardDescription,
        ...
        <CardHeader>
          ...
          <CardContent className="px-0">
            ...
            <div className="bg-gradient-to-r from-primary/5 border to-secondary/5 p-4 rounded-2xl">
              <span className="font-medium bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Permissions Granted: </span>
